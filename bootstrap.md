...
- `role-1-draft-editor.md`, `role-2-development-line-editor.md`, `role-3-copy-editor.md` — from the corresponding templates. Substitute the project's specific voice, terminology, and methodological references. These files will be read by Claude during writing phases; their job is to embed the project's `manifesto.md` and `voice.md` decisions into the editorial role itself.
